...
try:     
    ...
    with open("Calbot test results.txt", "a") as file:
        print("Pass - iCloud authorization in Firefox", file=file, sep="\n")
except:
    driver.save_screenshot("C:\\calbot\\Calbot screen\\Fail - iCloud authorization in Firefox.png")
    with open("Calbot test results.txt", "a") as file:
        print("Fail - iCloud authorization in Firefox.", file=file, sep="\n")
