...
try:     
    ...
    with open("Calbot test results.txt", "a") as file:
        print("Pass - Google authorization in google chrome", file=file, sep="\n")
except:
    driver.save_screenshot("C:\\calbot\\Calbot screen\\Fail - Google authorization in google chrome.png")
    with open("Calbot test results.txt", "a") as file:
        print("Fail - Google authorization in google chrome.", file=file, sep="\n")
