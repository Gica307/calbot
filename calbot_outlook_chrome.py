...
try:     
    ...
    driver.save_screenshot("C:\\calbot\\Calbot screen\\Fail - Outlook authorization in google chrome.png")
    with open("Calbot test results.txt", "a") as file:
        print("Fail - Outlook authorization in google chrome.", file=file, sep="\n")
