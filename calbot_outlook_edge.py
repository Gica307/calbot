...
try: 
    ...
    with open("Calbot test results.txt", "a") as file:
        print("Pass - Outlook authorization in Edge", file=file, sep="\n")
except:
    driver.save_screenshot("C:\\calbot\\Calbot screen\\Fail - Outlook authorization in Edge.png")
    with open("Calbot test results.txt", "a") as file:
        print("Fail - Outlook authorization in Edge.", file=file, sep="\n")
