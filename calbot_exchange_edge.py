...
try: 
    ...
    with open("Calbot test results.txt", "a") as file:
        print("Pass - Exchange authorization in Edge", file=file, sep="\n")
except:
    driver.save_screenshot("C:\\calbot\\Calbot screen\\Fail - Exchange authorization in Edge.png")
    with open("Calbot test results.txt", "a") as file:
        print("Fail - Exchange authorization in Edge.", file=file, sep="\n")
